...
export enum StringTemplates {
  ...
  GenerativeKnowleadgeAssistHelperText = 'CCAIGenerativeKnowleadgeAssistHelperText', 
  ProactiveGenerativeKnowleadgeAssistHelperText = 'CCAIProactiveGenerativeKnowleadgeAssistHelperText', 
...
export const stringHook = () => ({
  'en-US': {
    ...
    [StringTemplates.GenerativeKnowleadgeAssistHelperText]: 'Allow agents to search your knowleadge base for articles or FAQ documents.',
    [StringTemplates.ProactiveGenerativeKnowleadgeAssistHelperText]: 'Provides answers to your agents questions based on information in documents you provide.',
