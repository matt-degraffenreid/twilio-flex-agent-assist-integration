...
export default abstract class ApiService {
  ...
  constructor() {
    ...
    // use serverless_functions_domain_agent_assist from ui_attributes, or .env or set as undefined
    ...
    if (!this.serverlessDomain)
      logger.error('[ApiService] serverless_functions_domain_agent_assist is not set in flex config or env file');
  }
